...
describe('Blur Effect Utilities', () => {
  ...
  describe('Parameter Validation', () => {
    it('should validate blur parameters correctly', () => {
      ...
      expect(invalidResult.error?.message).toContain('Radius must be between 0 and 100')
      ...
      expect(invalidSigmaResult.error?.message).toContain('Sigma must be between 0 and 50')
    })
  })
})
